...
class Population
{
    public:
        ...
        Population(int const& squareLength, double const& sizeInitialEnzyme, double const& sizeInitialC, double const& sizeInitialD,
                 double const& indDeathZRate, double const& nbrEquivZD, double const& energCostZD,
                 double const& indDeathCRate, double const& creationCRate, double const& indBindZCRate,
                 double const& nbrEquivCD, double const& indDeathDRate, double const& creationDRate,
                 double const& erosion, double const& paramH, double const& diffusionD,
    ...
    private:
        ...
        std::vector<double> m_sizeZ; //total size of enzyme species
        std::vector<double> m_sizeC; //total size of carbonC species
        std::vector<double> m_sizeD; //total size of carbonD species
