...
//double Microbe::maxconsumptionDProdZ() const
//{
//    return m_phi * m_nbrEquivCarbonD * m_maxIndBirthRate;
//}
//
//
//double Microbe::maxconsumptionDProdM() const
//{
//    return (1-m_phi) * (m_nbrEquivCarbonD+m_nbrLooseCarbonD) * m_gammaM * m_maxIndBirthRate;
//}




void Microbe::carbonReleasedwhenDeath(double &carbonCReleased, double &carbonDReleased, double const& equivCD, double const& actualGrowth) const
{
    carbonDReleased = (1-m_paramP) * m_nbrEquivCarbonD * (1 + actualGrowth);
    carbonCReleased = (m_paramP) * m_nbrEquivCarbonD / equivCD * (1 + actualGrowth);
}
